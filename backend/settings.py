...
SECRET_KEY = 'uvm@y+88#8+9%r8a$6&ubff-w6dcrr%r#b@7j(1ep$vpte+0c&'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['sanskar-fyle-challenge-backend.herokuapp.com', '127.0.0.1']
# ALLOWED_HOSTS = []
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': 'bnz1jpuxidnwbn3vnd0f',
        'USER': 'ualcvrjikfqe0s1gt5il',
        'PASSWORD': 'orHtjHjHgSZGLlv3N6Vq',
        'HOST': 'bnz1jpuxidnwbn3vnd0f-postgresql.services.clever-cloud.com',
        'PORT': '5432',
    }
